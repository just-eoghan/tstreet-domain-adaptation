...
from src.models.modules.da_heads import DomainAdaptationModule
from src.models.modules.sa_da_heads import SaDomainAdaptationModule
from torchvision.models.detection.faster_rcnn import FastRCNNPredictor
from torchvision.models.resnet import ResNet50_Weights
from torchvision.models.detection.faster_rcnn import FasterRCNN
from src.models.modules.res_net_head import ResNetHead
from torchvision.models.detection.rpn import RPNHead, AnchorGenerator
from torchvision.ops.poolers import MultiScaleRoIAlign
from src.models.modules.da_frcnn_predictor import NoSaFastRCNNPredictor
...
class DaFRCNN(GeneralizedRCNN):
    ...
    def __init__(
        ...
        if scale_aware:
            ...
            anchor_generator = AnchorGenerator(sizes=(tuple([32, 64, 128, 256, 512]),),
            ...
            frcnn_base_model = FasterRCNN(
                                    ...
                                    box_nms_thresh=0.5,
                                    box_predictor=NoSaFastRCNNPredictor(num_classes=num_classes)
                                )
